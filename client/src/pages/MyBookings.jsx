...
const MyBookings = () => {
    ...
    if (loading) {
        return (
            <div className='py-28 px-4 md:px-16 lg:px-24 xl:px-32 flex items-center justify-center min-h-[60vh]'>
                ...
                {bookings.length === 0 ? (
                    <div className='text-center py-20'>
                        ...
                        <button
                            ...
                            className='mt-4 px-6 py-2 bg-primary text-white rounded-md hover:bg-primary-dull transition-all'
                        >
                            Browse Rooms
                        </button>
                    </div>
                            ...
                            <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t'>
                                ...
                                <div className='flex flex-col items-start justify-center pt-3'>
                                    <div className='flex items-center gap-2'>
                                        ...
                                        <p className={`text-sm ${booking.paymentStatus === "success"? "text-green-500": "text-red-500"}`}>{booking.paymentStatus === "success"? "Payment Successful": "Payment Failed"}
                                        </p>
                                    </div>
                                    {/* {!booking.isPaid && (
